...
<header id="header">
	...
	<div class="content" id="con">
	    <div class="row column text-center">
	      ...
	      <hr>
	      <div class="container">
	      	<form name="frm1" id="frm1" action="${path1 }/user/joinUser" method="post" onsubmit="return joinCheck(this)">
			      <table id="table1">
			      	<tbody>
			      		<tr>
			      		...
			      		<tr>
			      			<th style="background-color:#dcdcdc">출생년도</th>
			      			<td>
			      				<input type="number" name="birth" id="birth" placeholder="숫자만 입력" required>년
			      			</td>
			      		</tr>
			      		<tr>
